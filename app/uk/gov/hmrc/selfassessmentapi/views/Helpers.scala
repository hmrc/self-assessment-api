...
object Helpers extends HalSupport with Links {
  ...
  def enabledYearProperties(sourceType: SourceType): Set[AnnualSummaryType] = {
  ...
  def sourceTypeAndPropertyTypeResponse(utr: SaUtr, taxYear: TaxYear, sourceType: SourceType, propertyType: AnnualSummaryType, sourceId: SourceId, jsValue: Option[JsValue]) = {
