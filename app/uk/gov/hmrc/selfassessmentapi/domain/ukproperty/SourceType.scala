...
object SourceType {
  ...
  case object UKProperty extends SourceType {
    ...
    override val summaryTypes = Seq(SummaryTypes.Incomes,
                                    SummaryTypes.Expenses,
                                    SummaryTypes.TaxPaid,
                                    SummaryTypes.BalancingCharges,
                                    SummaryTypes.PrivateUseAdjustments)
