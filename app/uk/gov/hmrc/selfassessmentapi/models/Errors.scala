...
object Errors {
  ...
  object NinoNotFound extends Error(NINO_NOT_FOUND, "The remote endpoint has indicate that no data can be found for the nino", None)
  object TaxYearInvalid extends Error(TAX_YEAR_INVALID, "Invalid tax year", None)
  object TaxYearNotFound extends Error(TAX_YEAR_NOT_FOUND, "The remote endpoint has indicate that no data can be found for the tax year", None)
  ...
  object NoSubmissionDataExists extends Error("NOT_FOUND", "The remote endpoint has indicate that no data can be found", None)
