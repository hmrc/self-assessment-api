...
import uk.gov.hmrc.r2.selfassessmentapi.models.{TaxYear, banks}
...
object Bank {
  import uk.gov.hmrc.r2.selfassessmentapi.domain.JsonFormatters.BankFormatters.annualSummaryMapFormat
