...
package uk.gov.hmrc.r2.selfassessmentapi.models.des.charitablegiving

import play.api.libs.functional.syntax._
import play.api.libs.json.{Writes, __, _}
import uk.gov.hmrc.r2.selfassessmentapi.models.{charitablegiving, nonNegativeAmountValidator}
