...
trait MicroService {
  ...
  lazy val microservice = Project(appName, file("."))
    ...
    .settings(
      // statement coverage, what is the right value? discus
      coverageMinimum := 90,
      coverageFailOnMinimum := true,
      // ignore code generated by the Play Framework, or code that is just "plumbing"
      coverageExcludedPackages := Array(
        "com\\.kenshoo\\..*",
        "definition\\..*",
        "live\\..*",
        "prod\\..*",
        ...
        // reverse routing
        "uk\\.gov\\.hmrc\\.selfassessmentapi\\.controllers\\..*Reverse.*"
      ).mkString(";")
    )
}
