...
class SelfEmploymentEopsDeclarationResourceISpec extends IntegrationSpec {
  ...
  trait Test {
    ...
    def uri: String           = s"/ni/$nino/self-employments/123456789012345/end-of-period-statements/from/2018-01-01/to/2018-12-12"
    def downstreamUri: String = s"/2.0/ni/$nino/self-employments/123456789012345/end-of-period-statements/from/2018-01-01/to/2018-12-12"
