...
package uk.gov.hmrc.r1.selfassessmentapi.models.selfemployment

import uk.gov.hmrc.r2.selfassessmentapi.models.Class4NicsExemptionCode.{NON_RESIDENT, DIVER}
import uk.gov.hmrc.r2.selfassessmentapi.models.{Class4NicInfo, ErrorCode, des}
