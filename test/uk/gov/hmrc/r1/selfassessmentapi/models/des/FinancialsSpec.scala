...
package uk.gov.hmrc.r1.selfassessmentapi.models.des

import uk.gov.hmrc.r2.selfassessmentapi.models
import uk.gov.hmrc.r2.selfassessmentapi.models.des.selfemployment.{Deduction, Financials}
import uk.gov.hmrc.r2.selfassessmentapi.models.{Expense, ExpenseNegativeOrPositive, SimpleIncome, ExpenseProfessionalFees}
