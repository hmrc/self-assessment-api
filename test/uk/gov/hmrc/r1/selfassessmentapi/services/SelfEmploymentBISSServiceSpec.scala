...
package uk.gov.hmrc.r1.selfassessmentapi.services

import org.scalatest.mockito.MockitoSugar
import uk.gov.hmrc.domain.Nino
import uk.gov.hmrc.http.HeaderCarrier
import uk.gov.hmrc.r2.selfassessmentapi.UnitSpec
import uk.gov.hmrc.r2.selfassessmentapi.connectors.SelfEmploymentBISSConnector
import uk.gov.hmrc.r2.selfassessmentapi.fixtures.selfemployment.SelfEmploymentBISSFixture
import uk.gov.hmrc.r2.selfassessmentapi.mocks.connectors.MockSelfEmploymentBISSConnector
import uk.gov.hmrc.r2.selfassessmentapi.models.Errors.ErrorWrapper
import uk.gov.hmrc.r2.selfassessmentapi.models.{Errors, TaxYear}
