...
package uk.gov.hmrc.r1.selfassessmentapi.fixtures.selfemployment
...
import uk.gov.hmrc.r2.selfassessmentapi.models.selfemployment.{Adjustments, Allowances, NonFinancials, SelfEmploymentAnnualSummary}
