...
<p>You will need to add a UK property business in the sandbox environment before making a request. This endpoint will return the previously submitted data.</p>
<table>
    <thead>
        <tr>
